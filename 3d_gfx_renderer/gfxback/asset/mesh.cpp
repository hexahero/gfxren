...
namespace GFXREN {
    ...
    void MESH::setup_mesh() {
        ...
        glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(VRTX), (void*)0);
		
        glEnableVertexAttribArray(1);
        glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(VRTX), (void*)offsetof(VRTX, TexCoords));
		
        glEnableVertexAttribArray(2);
        glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(TEX), (void*)offsetof(VRTX, Normal));
